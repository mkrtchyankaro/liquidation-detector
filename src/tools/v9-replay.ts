 ...
 * "lateSlPct": 0). LIVE_ACCxx: trade only when the
 * accumulation after the cleaning had a sharp OI rise (30-min rise >= the
 * coin's Pxx of 30-min OI rises). OITURN_ACCxx: both together. Older variants:
...
const VARIANTS: Array<{
  ...
  // Sharp accumulation: after the cleaning, a 30-min OI rise >= the coin's Pxx of 30-min OI rises
  { name: "LIVE_ACC70", settings: { ...LIVE, minAccumPercentile: 70 } },
  { name: "LIVE_ACC90", settings: { ...LIVE, minAccumPercentile: 90 } },
  // Both together (Johnny): OI really grew after the cleaning, then fell with opposite liquidations, stop at the OI turn
  {
    name: "OITURN_ACC50",
    settings: { ...LIVE, lateSlPct: 0, minAccumPercentile: 50 },
  },
  {
    name: "OITURN_ACC70",
    settings: { ...LIVE, lateSlPct: 0, minAccumPercentile: 70 },
  },
  {
    name: "OITURN_ACC90",
    settings: { ...LIVE, lateSlPct: 0, minAccumPercentile: 90 },
  },
];
