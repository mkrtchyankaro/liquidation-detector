import type { Wave, ZBar } from "./oi-zigzag";
...
export function zigzagChartHtml(symbol: string, bars: readonly ZBar[], waves: readonly Wave[], rPct: number): string {
