...
export type V5TerminalReason =
  ...
  | "CANCEL_NO_SECOND_WAVE" // Sep 9 2026 (Karo), operator-designed Wave1/Wave2 requirement -- Wave 1 completed (1x UNIT recovery from its own extreme) but NO new same-victim liquidation ever started a genuine Wave 2 before price recovered a further 1x UNIT (2x UNIT total from Wave 1's own extreme). Purely price-structure-based, never time-based.
