...
//
//   node scripts/cascade-episodes-full-report-v6.js 4 9
//
// v6 CHANGES (operator's explicit instruction: the script itself must
// ANSWER the question with data, not just dump numbers for narration
// afterward):
