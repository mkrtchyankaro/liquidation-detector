...
//
//   node scripts/cascade-episodes-full-report-v10.js 5 6 2000000
//
// v10 CHANGES (operator's explicit, non-negotiable instructions --
// moving toward live within days):
  ...
  for (let epIdx = 0; epIdx < mergedRuns.length; epIdx++) {
    ...
    let cascadeEndMs = exhaustionEndMs;
    {
      ...
      if (startP !== null && windowCandles.length > 0) {
        ...
        const goingUp =
          windowCandles.some((c) => c.high > startP) &&
          !windowCandles.some((c) => c.low < startP * 0.999);
